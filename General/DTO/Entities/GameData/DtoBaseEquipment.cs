...
public class DtoBaseEquipment(int id, string name, ERarity rarity, bool isUnique, int equipmentTypeId, DtoEquipmentType? equipmentType, Dictionary<EStatType, Dice>? PossibleStats)
{
