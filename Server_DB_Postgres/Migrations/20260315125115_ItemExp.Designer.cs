...
namespace Server_DB_Postgres.Migrations
{
    ...
    [Migration("20260315125115_ItemExp")]
    partial class ItemExp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Collection.DropRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.PrimitiveCollection<int[]>("Counts")
                        .IsRequired()
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Collection.Equipment", b =>
                {
                    ...
                    b.Property<long?>("Agility_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("agility__1000");
                    ...
                    b.Property<long?>("CritChance_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("crit_chance__1000");

                    b.Property<long?>("CritMultiplier_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("crit_multiplier__1000");

                    b.Property<long?>("EnduranceMagical_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("endurance_magical__1000");

                    b.Property<long?>("EndurancePhysical_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("endurance_physical__1000");

                    b.Property<Dictionary<Guid, ItemExp>>("ExperienceHeroes")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("experience_heroes");
                    ...
                    b.Property<long?>("Haste_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("haste__1000");

                    b.Property<long?>("Health_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("health__1000");

                    b.Property<Guid?>("HeroId")
                        .HasColumnType("uuid")
                        .HasColumnName("hero_id");

                    b.Property<long?>("Initiative_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("initiative__1000");

                    b.Property<long>("Intelligence_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("intelligence__1000");

                    b.Property<int?>("SlotId")
                        .HasColumnType("integer")
                        .HasColumnName("slot_id");

                    b.Property<long?>("Strength_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("strength__1000");
                    ...
                    b.Property<long?>("Versality_1000")
                        .HasColumnType("bigint")
                        .HasColumnName("versality__1000");
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.GameData.BaseEquipment", b =>
                {
                    ...
                    b.Property<Dice>("CritChance_1000")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasColumnName("crit_chance__1000")
                    ...
                    b.Property<Dice>("CritMultiplier_1000")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasColumnName("crit_multiplier__1000")
                    ...
                    b.Property<Dice>("Damage_1000")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasColumnName("damage__1000")
                        .HasDefaultValueSql("'{\"c\":0,\"s\":0}'::jsonb");

                    b.Property<Dice>("EnduranceMagical_1000")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasColumnName("endurance_magical__1000")
                    ...
                    b.Property<Dice>("EndurancePhysical_1000")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasColumnName("endurance_physical__1000")
                    ...
                    b.Property<Dice>("Initiative_1000")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasColumnName("initiative__1000")
                    ...
                    b.Property<Dice>("Intelligence_1000")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasColumnName("intelligence__1000")
                    ...
                    b.Property<Dice>("Versality_1000")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasColumnName("versality__1000")
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Logs.AuthenticationLog", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("authentication_logs__pkey");

                    b.HasIndex("UserDeviceId")
                        .HasDatabaseName("authentication_logs__user_device_id__idx");

                    b.HasIndex("UserId")
                        .HasDatabaseName("authentication_logs__user_id__idx");

                    b.HasIndex("UserSessionId")
                        .HasDatabaseName("authentication_logs__user_session_id__idx");

                    b.ToTable("authentication_logs", "logs");
                });

            modelBuilder.Entity("Server_DB_Postgres.Entities.Logs.RegistrationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("registration_logs__pkey");

                    b.HasIndex("UserDeviceId")
                        .HasDatabaseName("registration_logs__user_device_id__idx");

                    b.HasIndex("UserId")
                        .HasDatabaseName("registration_logs__user_id__idx");

                    b.ToTable("registration_logs", "logs");
                });
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Server.UserSessionInactivationReason", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("user_session_inactivation_reasons__pkey");

                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("user_session_inactivation_reasons__code__idx");

                    b.ToTable("user_session_inactivation_reasons", "server");
                });
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Users.UserAccesskey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("user_accesskeys__pkey");

                    b.HasIndex("UserId")
                        .HasDatabaseName("user_accesskeys__user_id__idx");

                    b.ToTable("user_accesskeys", "users");
                });
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Users.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int?>("UserSessionInactivationReasonId")
                        .HasColumnType("integer")
                        .HasColumnName("user_session_inactivation_reason_id");
                    ...
                    b.HasKey("Id")
                        .HasName("user_sessions__pkey");

                    b.HasIndex("RefreshTokenHash")
                        .IsUnique()
                        .HasDatabaseName("user_sessions__refresh_token_hash__idx")
                        .HasFilter("is_used = false AND is_revoked = false");

                    b.HasIndex("UserDeviceId")
                        .HasDatabaseName("user_sessions__user_device_id__idx");

                    b.HasIndex("UserSessionInactivationReasonId")
                        .HasDatabaseName("user_sessions__user_session_inactivation_reason_id__idx");
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Collection.DropRate", b =>
                {
                    b.HasOne("Server_DB_Postgres.Entities.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("drop_rates__user_id__identity_users__fkey");
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Logs.AuthenticationLog", b =>
                {
                    b.HasOne("Server_DB_Postgres.Entities.Users.UserDevice", "UserDevice")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("authentication_logs__user_device_id__user_devices__fkey");

                    b.HasOne("Server_DB_Postgres.Entities.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("authentication_logs__user_id__identity_users__fkey");

                    b.HasOne("Server_DB_Postgres.Entities.Users.UserSession", "UserSession")
                        .WithMany()
                        .HasForeignKey("UserSessionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("authentication_logs__user_session_id__user_sessions__fkey");
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Logs.RegistrationLog", b =>
                {
                    b.HasOne("Server_DB_Postgres.Entities.Users.UserDevice", "UserDevice")
                        ...
                        .HasForeignKey("UserDeviceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("registration_logs__user_device_id__user_devices__fkey");
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Users.UserAccesskey", b =>
                {
                    b.HasOne("Server_DB_Postgres.Entities.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("user_accesskeys__user_id__identity_users__fkey");
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Users.UserSession", b =>
                {
                    ...
                    b.HasOne("Server_DB_Postgres.Entities.Server.UserSessionInactivationReason", "UserSessionInactivationReason")
                        .WithMany()
                        .HasForeignKey("UserSessionInactivationReasonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("user_sessions__user_session_inactivation_reason_id__user_session_inactivation_reasons__fkey");

                    b.Navigation("UserDevice");

                    b.Navigation("UserSessionInactivationReason");
                });
