...
public static class ServerErrors
{
    ...
    private const long a_WebSocket            = 0x0000_0003_0000_0000;
    ...
    private const long t_WebSocketOpening     = 0x0000_0000_0005_0000;
    ...
    private const long e_NotWebSocket         = 0x0000_0000_0000_0006;
    ...
    public enum Error : long
    {
        ...
        WebSocket_WebSocketOpening_NotWebSocket  = a_WebSocket         + t_WebSocketOpening  + e_NotWebSocket,
        WebSocket_WebSocketOpening_Unknown       = a_WebSocket         + t_WebSocketOpening  + e_Unknown,
    }
