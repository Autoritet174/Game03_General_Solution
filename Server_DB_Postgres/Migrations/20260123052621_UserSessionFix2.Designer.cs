...
namespace Server_DB_Postgres.Migrations
{
    ...
    [Migration("20260123052621_UserSessionFix2")]
    partial class UserSessionFix2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Users.UserPasskey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("user_passkeys__pkey");

                    b.HasIndex("UserId")
                        .HasDatabaseName("user_passkeys__user_id__idx");

                    b.ToTable("user_passkeys", "users");
                });
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Users.UserSession", b =>
                {
                    ...
                    b.Property<string>("InactivationReason")
                        .HasColumnType("text")
                        .HasColumnName("inactivation_reason");
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Users.UserPasskey", b =>
                {
                    b.HasOne("Server_DB_Postgres.Entities.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("user_passkeys__user_id__identity_users__fkey");
