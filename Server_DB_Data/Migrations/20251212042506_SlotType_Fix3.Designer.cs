...
namespace Server_DB_Data.Migrations
{
    ...
    [Migration("20251212042506_SlotType_Fix3")]
    partial class SlotType_Fix3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Server_DB_Data.Entities.X_Cross.X_EquipmentType_DamageType", b =>
                {
                    ...
                    b.HasKey("EquipmentTypeId", "DamageTypeId")
                        .HasName("X_EquipmentType_DamageType_pkey");

                    b.HasIndex("DamageTypeId")
                        .HasDatabaseName("X_EquipmentType_DamageType_DamageTypeId_idx");

                    b.HasIndex("EquipmentTypeId")
                        .HasDatabaseName("X_EquipmentType_DamageType_EquipmentTypeId_idx");
            ...
            modelBuilder.Entity("Server_DB_Data.Entities.__Lists.EquipmentType", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("EquipmentType_pkey");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("EquipmentType_name_idx");

                    b.HasIndex("SlotTypeId")
                        .HasDatabaseName("EquipmentType_slot_type_id_idx");

                    b.ToTable("EquipmentType", "__lists");
                });
            ...
            modelBuilder.Entity("Server_DB_Data.Entities.__Lists.MaterialDamagePercent", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("MaterialDamagePercent_pkey");

                    b.HasIndex("DamageTypeId")
                        .HasDatabaseName("MaterialDamagePercent_damage_type_id_idx");

                    b.HasIndex("SmithingMaterialsId")
                        .HasDatabaseName("MaterialDamagePercent_smithing_materials_id_idx");

                    b.ToTable("MaterialDamagePercent", "__lists");
                });
            ...
            modelBuilder.Entity("Server_DB_Data.Entities.__Lists.SlotType", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("SlotType_pkey");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("SlotType_name_idx");

                    b.ToTable("SlotType", "__lists");
                });
            ...
            modelBuilder.Entity("Server_DB_Data.Entities.X_Cross.X_EquipmentType_DamageType", b =>
                {
                    b.HasOne("Server_DB_Data.Entities.__Lists.DamageType", "DamageType")
                        ...
                        .IsRequired()
                        .HasConstraintName("X_EquipmentType_DamageType_damage_type_id_damage_types_fkey");
                    ...
                    b.HasOne("Server_DB_Data.Entities.__Lists.EquipmentType", "EquipmentType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("X_EquipmentType_DamageType_equipment_type_id_equipment_type_fkey");
            ...
            modelBuilder.Entity("Server_DB_Data.Entities._Equipment.Weapon", b =>
                {
                    b.HasOne("Server_DB_Data.Entities.__Lists.EquipmentType", "WeaponTypes")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("Weapons_weapon_type_id_equipment_type_fkey");
            ...
            modelBuilder.Entity("Server_DB_Data.Entities.__Lists.EquipmentType", b =>
                {
                    b.HasOne("Server_DB_Data.Entities.__Lists.SlotType", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("EquipmentType_slot_type_id_slot_type_fkey");
                });
            ...
            modelBuilder.Entity("Server_DB_Data.Entities.__Lists.MaterialDamagePercent", b =>
                {
                    b.HasOne("Server_DB_Data.Entities.__Lists.DamageType", "DamageType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("MaterialDamagePercent_damage_type_id_damage_types_fkey");
                    ...
                    b.HasOne("Server_DB_Data.Entities.__Lists.SmithingMaterials", "SmithingMaterials")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("MaterialDamagePercent_smithing_materials_id_smithing_materials_fkey");
