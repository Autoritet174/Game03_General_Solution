...
namespace Server_DB_Postgres.Migrations
{
    ...
    [Migration("20260515064837_Migration_20260515_144823")]
    partial class Migration_20260515_144823
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("General.DTO.Entities.GameData.Battlefield", b =>
                {
                    ...
                    b.Property<int>("MaxEnemyCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(12)
                        .HasColumnName("max_enemy_count");

                    b.Property<int>("MaxHeroCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(12)
                        .HasColumnName("max_hero_count");
            ...
            modelBuilder.Entity("Server_DB_Postgres.Entities.Server.UserSessionInactivationReason", b =>
                {
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("user_session_inactivation_reasons__name__idx");
            ...
            modelBuilder.Entity("General.DTO.Entities.Collection.Equipment", b =>
                {
                    ...
                    b.HasOne("General.DTO.Entities.Collection.Hero", null)
                        .WithMany()
                        .HasForeignKey("HeroId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("equipments__hero_id__heroes__fkey");

                    b.HasOne("General.DTO.Entities.GameData.Slot", null)
                        .WithMany()
