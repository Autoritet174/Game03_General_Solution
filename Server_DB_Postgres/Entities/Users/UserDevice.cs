...
[Index(nameof(DeviceUniqueIdentifier), IsUnique = true)]
public class UserDevice : ICreatedAt
{
    ...
    [MaxLength(255)]
    public required string SystemEnvironmentUserName { get; set; }
    ...
    [MaxLength(255)]
    public required string GraphicsDeviceName { get; set; }
    ...
    [MaxLength(255)]
    public required string SystemInfo_npotSupport { get; set; }
}
