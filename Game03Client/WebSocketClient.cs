...
namespace Game03Client
{
    public class WebSocketClient
    {
        ...
        public async Task ConnectAsync()
        {
            ...
            //if (!string.IsNullOrEmpty(MemoryCache.JwtToken))//ИСПРАВИТЬ
            //{
            //    _webSocket.Options.SetRequestHeader("Authorization", $"Bearer {MemoryCache.JwtToken}");//ИСПРАВИТЬ
            //}
            ...
            {
                //GameMessage.Show($"Ошибка подключения: {ex1.Message}", true);//ИСПРАВИТЬ
